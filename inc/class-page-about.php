...
/* 				max-width: 960px; */
			...
			.backwpup_comp table tbody tr.even {
				background-image: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/even.png);
			}

			.backwpup_comp table tbody tr.odd {
				background-image: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/odd.png);
			}

			.backwpup_comp table tbody tr.ub td.pro {
				height: 50px;
				text-align: center;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hgtopgreen.png) no-repeat bottom center;
				color: #fff;
			...
			.backwpup_comp table tbody tr.ubdown td.pro {
				height: 50px;
				text-align: center;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hgbtgreen.png) no-repeat top center;
				color: #fff;
			...
			.backwpup_comp table tbody tr.ubdown td.free {
				height: 50px;
				text-align: center;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hgbtred.png) no-repeat top center;
				color: #fff;
			}
			...
			.backwpup_comp table tbody tr.even td.tick {
				width: 100px;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/tickeven.png) no-repeat center;
			...
			.backwpup_comp table tbody tr.odd td.tick {
				width: 100px;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/tickodd.png) no-repeat center;
				border-left: 1px solid #799e14;
			}

			.backwpup_comp table tbody tr.even td.error {
				width: 100px;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/erroreven.png) no-repeat center;
			...
			.backwpup_comp table tbody tr.odd td.error {
				width: 100px;
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/errorodd.png) no-repeat center;
			}

			.backwpup_comp table tbody tr.even:hover {
				background-image: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hover.png);
			}
			...
			.backwpup_comp table tbody tr.even:hover td.tick {
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/tickhover.png) center;
			}
			...
			.backwpup_comp table tbody tr.even:hover td.error {
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/errorhover.png) center;
			}
			...
			.backwpup_comp table tbody tr.ubdown:hover td.pro:hover {
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hgbtgreenhover.png) no-repeat top center;
				background-color: #255667;
			}

			.backwpup_comp table tbody tr.ubdown:hover td.free:hover {
				background: url(<?php echo esc_url( BackWPup::get_plugin_data( 'URL' ) ); ?>/assets/images/hgbtredhover.png) no-repeat top center;
			}
		</style>
		<?php
	}
				...
				<div class="welcome_inner">
								...
								echo wp_kses(
									str_replace(
										...
										sprintf(
											...
											__( 'Ready to <a href="%1$s">set up a backup job</a>? You can <a href="%2$s">use the wizards</a> or plan your backup in expert mode.', 'backwpup' ),
											esc_url( network_admin_url( 'admin.php' ) . '?page=backwpupeditjob' ),
											esc_url( network_admin_url( 'admin.php' ) . '?page=backwpupwizard' )
										)
									),
									[
										'a' => [
									...
									echo wp_kses(
										str_replace(
											...
											sprintf(
												...
												__( 'With BackWPup you can schedule the database backup to run automatically. With a single backup file you can restore your database. You should <a href="%s">set up a backup job</a>, so you will never forget it. There is also an option to repair and optimize the database after each backup.', 'backwpup' ),
												esc_url( network_admin_url( 'admin.php' ) . '?page=backwpupeditjob' )
											)
										),
										[
								...
								<?php
									echo wp_kses(
										str_replace(
											...
											sprintf(
												// translators: %s: edit job URL.
												__( 'You can backup all your attachments, also all system files, plugins and themes in a single file. You can <a href="%s">create a job</a> to update a backup copy of your file system only when files are changed.', 'backwpup' ),
												esc_url( network_admin_url( 'admin.php' ) . '?page=backwpupeditjob' )
											)
										),
										[
					...
					<div class="backwpup_comp">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr class="<?php self::row_class(); ?>">
								<td><strong><?php esc_html_e( 'Premium support', 'backwpup' ); ?></strong></td>
								<td class="error"></td>
								<td class="tick"></td>
							</tr>
							<tr class="<?php self::row_class(); ?>">
								<td><strong><?php esc_html_e( 'Automatic updates', 'backwpup' ); ?></strong></td>
