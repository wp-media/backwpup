...
<p>
	...
	// Translators: %1$s = <br>, %2$s = <a>, %3$s = </a>, %4$s = <a>, %5$s = </a>.
		...
		'</a>',
		'<a target="_blank" href="' . esc_url( wpm_apply_filters_typed( 'string', 'backwpup_url_add_hash', 'https://backwpup.com/docs/article/reactivating-backup-jobs-after-update/?utm_source=backwpup_plugin&utm_medium=plugin&utm_campaign=in_product&utm_content=reactivate_jobs_help' ) ) . '">',
		'</a>',
		'<strong>',
		'</strong>'
	);
