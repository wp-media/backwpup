...
use WPMedia\BackWPup\Dependencies\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `WPMedia\BackWPup\Dependencies\Psr\Http\Message\StreamInterface`: Returns the value as-is.
