...
/**
 * Notice after update to 5.2.2
 */
class Notice522 extends AbstractNotice {

	/**
	 * The unique ID for this notice.
	 */
	public const ID = 'notice_5_2_2';
	...
	protected function should_display(): bool {
		...
		// We will show this notice only with version 5.2.2 and all its sub-versions.
		return version_compare( $new_version, '5.2.2', '>=' ) && version_compare( $new_version, '5.3', '<' );
	}
